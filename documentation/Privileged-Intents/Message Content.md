...
# fun.duck
## Usage
This modules runs a duckhunt game in a configured channel, with the goal being to have users type "bef" or "bang" to befriend or shoot the duck.<br>
...
# moderation.events
## Usage
This module tracks and logs a handful of events across the server, including some which will display message content.<br>
...
# operation.forum
## Usage
This module monitors new threads being created in a configured forum channel. The message content of the original message is compared to a set of rules.<br>
